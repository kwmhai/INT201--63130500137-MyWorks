...
//CookieUtil.set('name', 'Umaporn');
 CookieUtil.set('book', 'JavaScript Beginner', new Date('January 1, 2022'));
...
// //overwrite cookies
 CookieUtil.set('book', 'JavaScript Tutorial', new Date('January 1, 2022')); //overwrite because same path and name
